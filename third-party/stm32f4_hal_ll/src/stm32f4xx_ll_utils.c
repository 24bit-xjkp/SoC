...
#define IS_LL_UTILS_PLLM_VALUE(__VALUE__)                                                                                        \
    (((__VALUE__) == LL_RCC_PLLM_DIV_2) || ((__VALUE__) == LL_RCC_PLLM_DIV_3) || ((__VALUE__) == LL_RCC_PLLM_DIV_4) ||           \
     ((__VALUE__) == LL_RCC_PLLM_DIV_5) || ((__VALUE__) == LL_RCC_PLLM_DIV_6) || ((__VALUE__) == LL_RCC_PLLM_DIV_7) ||           \
     ((__VALUE__) == LL_RCC_PLLM_DIV_8) || ((__VALUE__) == LL_RCC_PLLM_DIV_9) || ((__VALUE__) == LL_RCC_PLLM_DIV_10) ||          \
     ((__VALUE__) == LL_RCC_PLLM_DIV_11) || ((__VALUE__) == LL_RCC_PLLM_DIV_12) || ((__VALUE__) == LL_RCC_PLLM_DIV_13) ||        \
     ((__VALUE__) == LL_RCC_PLLM_DIV_14) || ((__VALUE__) == LL_RCC_PLLM_DIV_15) || ((__VALUE__) == LL_RCC_PLLM_DIV_16) ||        \
     ((__VALUE__) == LL_RCC_PLLM_DIV_17) || ((__VALUE__) == LL_RCC_PLLM_DIV_18) || ((__VALUE__) == LL_RCC_PLLM_DIV_19) ||        \
     ((__VALUE__) == LL_RCC_PLLM_DIV_20) || ((__VALUE__) == LL_RCC_PLLM_DIV_21) || ((__VALUE__) == LL_RCC_PLLM_DIV_22) ||        \
     ((__VALUE__) == LL_RCC_PLLM_DIV_23) || ((__VALUE__) == LL_RCC_PLLM_DIV_24) || ((__VALUE__) == LL_RCC_PLLM_DIV_25) ||        \
     ((__VALUE__) == LL_RCC_PLLM_DIV_26) || ((__VALUE__) == LL_RCC_PLLM_DIV_27) || ((__VALUE__) == LL_RCC_PLLM_DIV_28) ||        \
     ((__VALUE__) == LL_RCC_PLLM_DIV_29) || ((__VALUE__) == LL_RCC_PLLM_DIV_30) || ((__VALUE__) == LL_RCC_PLLM_DIV_31) ||        \
     ((__VALUE__) == LL_RCC_PLLM_DIV_32) || ((__VALUE__) == LL_RCC_PLLM_DIV_33) || ((__VALUE__) == LL_RCC_PLLM_DIV_34) ||        \
     ((__VALUE__) == LL_RCC_PLLM_DIV_35) || ((__VALUE__) == LL_RCC_PLLM_DIV_36) || ((__VALUE__) == LL_RCC_PLLM_DIV_37) ||        \
     ((__VALUE__) == LL_RCC_PLLM_DIV_38) || ((__VALUE__) == LL_RCC_PLLM_DIV_39) || ((__VALUE__) == LL_RCC_PLLM_DIV_40) ||        \
     ((__VALUE__) == LL_RCC_PLLM_DIV_41) || ((__VALUE__) == LL_RCC_PLLM_DIV_42) || ((__VALUE__) == LL_RCC_PLLM_DIV_43) ||        \
     ((__VALUE__) == LL_RCC_PLLM_DIV_44) || ((__VALUE__) == LL_RCC_PLLM_DIV_45) || ((__VALUE__) == LL_RCC_PLLM_DIV_46) ||        \
     ((__VALUE__) == LL_RCC_PLLM_DIV_47) || ((__VALUE__) == LL_RCC_PLLM_DIV_48) || ((__VALUE__) == LL_RCC_PLLM_DIV_49) ||        \
     ((__VALUE__) == LL_RCC_PLLM_DIV_50) || ((__VALUE__) == LL_RCC_PLLM_DIV_51) || ((__VALUE__) == LL_RCC_PLLM_DIV_52) ||        \
     ((__VALUE__) == LL_RCC_PLLM_DIV_53) || ((__VALUE__) == LL_RCC_PLLM_DIV_54) || ((__VALUE__) == LL_RCC_PLLM_DIV_55) ||        \
     ((__VALUE__) == LL_RCC_PLLM_DIV_56) || ((__VALUE__) == LL_RCC_PLLM_DIV_57) || ((__VALUE__) == LL_RCC_PLLM_DIV_58) ||        \
     ((__VALUE__) == LL_RCC_PLLM_DIV_59) || ((__VALUE__) == LL_RCC_PLLM_DIV_60) || ((__VALUE__) == LL_RCC_PLLM_DIV_61) ||        \
...
#define IS_LL_UTILS_PLLP_VALUE(__VALUE__)                                                                                        \
    (((__VALUE__) == LL_RCC_PLLP_DIV_2) || ((__VALUE__) == LL_RCC_PLLP_DIV_4) || ((__VALUE__) == LL_RCC_PLLP_DIV_6) ||           \
...
ErrorStatus LL_SetFlashLatency(uint32_t HCLK_Frequency)
{
    ...
    if(HCLK_Frequency == 0U) { status = ERROR; }
    else
    {
        if(LL_PWR_GetRegulVoltageScaling() == LL_PWR_REGU_VOLTAGE_SCALE1)
        {
#if defined(UTILS_SCALE1_LATENCY5_FREQ)
            if((HCLK_Frequency > UTILS_SCALE1_LATENCY5_FREQ) && (latency == LL_FLASH_LATENCY_0)) { latency = LL_FLASH_LATENCY_5; }
#endif /*UTILS_SCALE1_LATENCY5_FREQ */
#if defined(UTILS_SCALE1_LATENCY4_FREQ)
            if((HCLK_Frequency > UTILS_SCALE1_LATENCY4_FREQ) && (latency == LL_FLASH_LATENCY_0)) { latency = LL_FLASH_LATENCY_4; }
#endif /* UTILS_SCALE1_LATENCY4_FREQ */
#if defined(UTILS_SCALE1_LATENCY3_FREQ)
            if((HCLK_Frequency > UTILS_SCALE1_LATENCY3_FREQ) && (latency == LL_FLASH_LATENCY_0)) { latency = LL_FLASH_LATENCY_3; }
#endif /* UTILS_SCALE1_LATENCY3_FREQ */
#if defined(UTILS_SCALE1_LATENCY2_FREQ)
            if((HCLK_Frequency > UTILS_SCALE1_LATENCY2_FREQ) && (latency == LL_FLASH_LATENCY_0)) { latency = LL_FLASH_LATENCY_2; }
            else
            {
        ...
        if(LL_PWR_GetRegulVoltageScaling() == LL_PWR_REGU_VOLTAGE_SCALE2)
        {
            ...
            if((HCLK_Frequency > UTILS_SCALE2_LATENCY5_FREQ) && (latency == LL_FLASH_LATENCY_0)) { latency = LL_FLASH_LATENCY_5; }
#endif /*UTILS_SCALE1_LATENCY5_FREQ */
#if defined(UTILS_SCALE2_LATENCY4_FREQ)
            if((HCLK_Frequency > UTILS_SCALE2_LATENCY4_FREQ) && (latency == LL_FLASH_LATENCY_0)) { latency = LL_FLASH_LATENCY_4; }
#endif /*UTILS_SCALE1_LATENCY4_FREQ */
#if defined(UTILS_SCALE2_LATENCY3_FREQ)
            if((HCLK_Frequency > UTILS_SCALE2_LATENCY3_FREQ) && (latency == LL_FLASH_LATENCY_0)) { latency = LL_FLASH_LATENCY_3; }
#endif /*UTILS_SCALE1_LATENCY3_FREQ */
            if((HCLK_Frequency > UTILS_SCALE2_LATENCY2_FREQ) && (latency == LL_FLASH_LATENCY_0)) { latency = LL_FLASH_LATENCY_2; }
            else
            {
        ...
        if(LL_PWR_GetRegulVoltageScaling() == LL_PWR_REGU_VOLTAGE_SCALE3)
        {
            ...
            if((HCLK_Frequency > UTILS_SCALE3_LATENCY3_FREQ) && (latency == LL_FLASH_LATENCY_0)) { latency = LL_FLASH_LATENCY_3; }
    #endif /*UTILS_SCALE1_LATENCY3_FREQ */
    #if defined(UTILS_SCALE3_LATENCY2_FREQ)
            if((HCLK_Frequency > UTILS_SCALE3_LATENCY2_FREQ) && (latency == LL_FLASH_LATENCY_0)) { latency = LL_FLASH_LATENCY_2; }
            else
            {
        ...
        if(getlatency != latency) { status = ERROR; }
        else { status = SUCCESS; }
    }
    return status;
}
                                         ...
                                         LL_UTILS_ClkInitTypeDef* UTILS_ClkInitStruct)
{
    ...
    if(UTILS_PLL_IsBusy() == SUCCESS)
    {
        ...
        {
            LL_RCC_HSI_Enable();
            while(LL_RCC_HSI_IsReady() != 1U) { /* Wait for HSI ready */ }
        }
                                         ...
                                         LL_UTILS_ClkInitTypeDef* UTILS_ClkInitStruct)
{
    ...
    if(UTILS_PLL_IsBusy() == SUCCESS)
    {
        ...
        if(LL_RCC_HSE_IsReady() != 1U)
        {
            ...
            if(HSEBypass == LL_UTILS_HSEBYPASS_ON) { LL_RCC_HSE_EnableBypass(); }
            else { LL_RCC_HSE_DisableBypass(); }

            /* Enable HSE */
            LL_RCC_HSE_Enable();
            while(LL_RCC_HSE_IsReady() != 1U) { /* Wait for HSE ready */ }
        }
...
static ErrorStatus UTILS_EnablePLLAndSwitchSystem(uint32_t SYSCLK_Frequency, LL_UTILS_ClkInitTypeDef* UTILS_ClkInitStruct)
{
    ...
    if(status == SUCCESS)
    {
        /* Enable PLL */
        LL_RCC_PLL_Enable();
        while(LL_RCC_PLL_IsReady() != 1U) { /* Wait for PLL ready */ }

        /* Sysclk activation on the main PLL */
        LL_RCC_SetAHBPrescaler(UTILS_ClkInitStruct->AHBCLKDivider);
        LL_RCC_SetSysClkSource(LL_RCC_SYS_CLKSOURCE_PLL);
        while(LL_RCC_GetSysClkSource() != LL_RCC_SYS_CLKSOURCE_STATUS_PLL) { /* Wait for system clock switch to PLL */ }
    ...
    if(status == SUCCESS) { LL_SetSystemCoreClock(hclk_frequency); }
