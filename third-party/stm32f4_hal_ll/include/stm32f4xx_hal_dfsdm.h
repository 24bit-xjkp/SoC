...
extern "C"
{
    ...
    #endif /* USE_HAL_DFSDM_REGISTER_CALLBACKS */
    {
        ...
        void (*RegConvHalfCpltCallback)(
            struct __DFSDM_Filter_HandleTypeDef* hdfsdm_filter); /*!< DFSDM filter half regular conversion complete callback */
        ...
        void (*InjConvHalfCpltCallback)(
            struct __DFSDM_Filter_HandleTypeDef* hdfsdm_filter); /*!< DFSDM filter half injected conversion complete callback */
     ...
     */
        ...
        #define DFSDM_FILTER_EXT_TRIG_TIM7_TRGO                                                                                  \
            (DFSDM_FLTCR1_JEXTSEL_0 | DFSDM_FLTCR1_JEXTSEL_2) /*!< For DFSDM2 filter 2 and                                       \
                                                                 3*/
        ...
        #define DFSDM_FILTER_EXT_TRIG_TIM10_OC1                                                                                  \
            (DFSDM_FLTCR1_JEXTSEL_0 | DFSDM_FLTCR1_JEXTSEL_1)          /*!< For DFSDM1 filter 0 and                              \
                                                                          1*/
        #define DFSDM_FILTER_EXT_TRIG_TIM4_TRGO DFSDM_FLTCR1_JEXTSEL_2 /*!< For DFSDM1 filter 0 and 1*/
        #define DFSDM_FILTER_EXT_TRIG_TIM6_TRGO                                                                                  \
            (DFSDM_FLTCR1_JEXTSEL_0 | DFSDM_FLTCR1_JEXTSEL_2) /*!< For DFSDM1 filter 0 and                                       \
                                                                 1*/
        #define DFSDM_FILTER_EXT_TRIG_EXTI11                                                                                     \
            (DFSDM_FLTCR1_JEXTSEL_1 | DFSDM_FLTCR1_JEXTSEL_2)     /*!< For DFSDM1 filter 0 and                                   \
                                                                     1*/
