...
#define __HAL_TIM_DISABLE(__HANDLE__)                                                                                            \
    do {                                                                                                                         \
        ...
        {                                                                                                                        \
            if(((__HANDLE__)->Instance->CCER & TIM_CCER_CCxNE_MASK) == 0UL) { (__HANDLE__)->Instance->CR1 &= ~(TIM_CR1_CEN); }   \
        }                                                                                                                        \
    }                                                                                                                            \
    while(0)
...
#define __HAL_TIM_MOE_DISABLE(__HANDLE__)                                                                                        \
    do {                                                                                                                         \
        if(((__HANDLE__)->Instance->CCER & TIM_CCER_CCxE_MASK) == 0UL)                                                           \
        {                                                                                                                        \
            if(((__HANDLE__)->Instance->CCER & TIM_CCER_CCxNE_MASK) == 0UL) { (__HANDLE__)->Instance->BDTR &= ~(TIM_BDTR_MOE); } \
        }                                                                                                                        \
    }                                                                                                                            \
    while(0)
...
#define IS_TIM_PERIOD(__HANDLE__, __PERIOD__)                                                                                    \
    ((IS_TIM_32B_COUNTER_INSTANCE(((__HANDLE__)->Instance)) == 0U) ? (((__PERIOD__) > 0U) && ((__PERIOD__) <= 0x0000FFFFU))      \
                                                                   : ((__PERIOD__) > 0U))
...
#define IS_TIM_CLOCKSOURCE(__CLOCK__)                                                                                            \
    (((__CLOCK__) == TIM_CLOCKSOURCE_INTERNAL) || ((__CLOCK__) == TIM_CLOCKSOURCE_ETRMODE1) ||                                   \
     ...
     ((__CLOCK__) == TIM_CLOCKSOURCE_TI1) || ((__CLOCK__) == TIM_CLOCKSOURCE_TI2) || ((__CLOCK__) == TIM_CLOCKSOURCE_ITR0) ||    \
