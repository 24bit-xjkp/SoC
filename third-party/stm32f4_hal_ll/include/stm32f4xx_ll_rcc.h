...
#include "stm32f4xx.h"
    ...
    #define LL_RCC_PLLQ_DIV_11                                                                                                   \
        (RCC_PLLCFGR_PLLQ_3 | RCC_PLLCFGR_PLLQ_1 | RCC_PLLCFGR_PLLQ_0)   /*!< Main PLL division factor for PLLQ output by 11 */
    ...
    #define LL_RCC_PLLQ_DIV_13                                                                                                   \
        (RCC_PLLCFGR_PLLQ_3 | RCC_PLLCFGR_PLLQ_2 | RCC_PLLCFGR_PLLQ_0) /*!< Main PLL division factor for PLLQ output by 13 */
    #define LL_RCC_PLLQ_DIV_14                                                                                                   \
        (RCC_PLLCFGR_PLLQ_3 | RCC_PLLCFGR_PLLQ_2 | RCC_PLLCFGR_PLLQ_1) /*!< Main PLL division factor for PLLQ output by 14 */
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RCC_SetCECClockSource(uint32_t Source) { MODIFY_REG(RCC->DCKCFGR2, RCC_DCKCFGR2_CECSEL, Source); }
    #endif /* CEC */
     ...
     *         (*) value not defined in all devices.
     */
    __STATIC_INLINE uint32_t LL_RCC_GetDFSDMClockSource(uint32_t DFSDMx) { return (uint32_t)(READ_BIT(RCC->DCKCFGR, DFSDMx)); }
    #endif /* DFSDM1_Channel0 */
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RCC_SetRTC_HSEPrescaler(uint32_t Prescaler) { MODIFY_REG(RCC->CFGR, RCC_CFGR_RTCPRE, Prescaler); }
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RCC_SetTIMPrescaler(uint32_t Prescaler) { MODIFY_REG(RCC->DCKCFGR, RCC_DCKCFGR_TIMPRE, Prescaler); }
     ...
     */
    __STATIC_INLINE uint32_t LL_RCC_PLL_GetPeriodModulation(void) { return (uint32_t)(READ_BIT(RCC->SSCGR, RCC_SSCGR_MODPER)); }
     ...
     *         @arg @ref LL_RCC_SPREAD_SELECT_DOWN
     */
    __STATIC_INLINE uint32_t LL_RCC_PLL_GetSpreadSelection(void) { return (uint32_t)(READ_BIT(RCC->SSCGR, RCC_SSCGR_SPREADSEL)); }
     ...
     * @retval State of bit (1 or 0).
     */
    __STATIC_INLINE uint32_t LL_RCC_PLLI2S_IsReady(void) { return (READ_BIT(RCC->CR, RCC_CR_PLLI2SRDY) == (RCC_CR_PLLI2SRDY)); }
     ...
     *         @arg @ref LL_RCC_PLLI2SQ_DIV_15
     */
    __STATIC_INLINE uint32_t LL_RCC_PLLI2S_GetQ(void) { return (uint32_t)(READ_BIT(RCC->PLLI2SCFGR, RCC_PLLI2SCFGR_PLLI2SQ)); }
        #endif /* RCC_PLLI2SCFGR_PLLI2SQ */
     ...
     *         @arg @ref LL_RCC_PLLI2SR_DIV_7
     */
    __STATIC_INLINE uint32_t LL_RCC_PLLI2S_GetR(void) { return (uint32_t)(READ_BIT(RCC->PLLI2SCFGR, RCC_PLLI2SCFGR_PLLI2SR)); }
     ...
     *         @arg @ref LL_RCC_PLLI2SP_DIV_8
     */
    __STATIC_INLINE uint32_t LL_RCC_PLLI2S_GetP(void) { return (uint32_t)(READ_BIT(RCC->PLLI2SCFGR, RCC_PLLI2SCFGR_PLLI2SP)); }
        #endif /* RCC_PLLI2SCFGR_PLLI2SP */
     ...
     *         @arg @ref LL_RCC_PLLI2SDIVQ_DIV_32
     */
    __STATIC_INLINE uint32_t LL_RCC_PLLI2S_GetDIVQ(void) { return (uint32_t)(READ_BIT(RCC->DCKCFGR, RCC_DCKCFGR_PLLI2SDIVQ)); }
        #endif /* RCC_DCKCFGR_PLLI2SDIVQ */
     ...
     *         @arg @ref LL_RCC_PLLI2SDIVR_DIV_31
     */
    __STATIC_INLINE uint32_t LL_RCC_PLLI2S_GetDIVR(void) { return (uint32_t)(READ_BIT(RCC->DCKCFGR, RCC_DCKCFGR_PLLI2SDIVR)); }
        #endif /* RCC_DCKCFGR_PLLI2SDIVR */
     ...
     * @retval State of bit (1 or 0).
     */
    __STATIC_INLINE uint32_t LL_RCC_PLLSAI_IsReady(void) { return (READ_BIT(RCC->CR, RCC_CR_PLLSAIRDY) == (RCC_CR_PLLSAIRDY)); }
     ...
     *         @arg @ref LL_RCC_PLLSAIQ_DIV_15
     */
    __STATIC_INLINE uint32_t LL_RCC_PLLSAI_GetQ(void) { return (uint32_t)(READ_BIT(RCC->PLLSAICFGR, RCC_PLLSAICFGR_PLLSAIQ)); }
     ...
     *         @arg @ref LL_RCC_PLLSAIR_DIV_7
     */
    __STATIC_INLINE uint32_t LL_RCC_PLLSAI_GetR(void) { return (uint32_t)(READ_BIT(RCC->PLLSAICFGR, RCC_PLLSAICFGR_PLLSAIR)); }
        #endif /* RCC_PLLSAICFGR_PLLSAIR */
     ...
     *         @arg @ref LL_RCC_PLLSAIP_DIV_8
     */
    __STATIC_INLINE uint32_t LL_RCC_PLLSAI_GetP(void) { return (uint32_t)(READ_BIT(RCC->PLLSAICFGR, RCC_PLLSAICFGR_PLLSAIP)); }
        #endif /* RCC_PLLSAICFGR_PLLSAIP */
     ...
     *         @arg @ref LL_RCC_PLLSAIDIVQ_DIV_32
     */
    __STATIC_INLINE uint32_t LL_RCC_PLLSAI_GetDIVQ(void) { return (uint32_t)(READ_BIT(RCC->DCKCFGR, RCC_DCKCFGR_PLLSAIDIVQ)); }
     ...
     *         @arg @ref LL_RCC_PLLSAIDIVR_DIV_16
     */
    __STATIC_INLINE uint32_t LL_RCC_PLLSAI_GetDIVR(void) { return (uint32_t)(READ_BIT(RCC->DCKCFGR, RCC_DCKCFGR_PLLSAIDIVR)); }
        #endif /* RCC_DCKCFGR_PLLSAIDIVR */
