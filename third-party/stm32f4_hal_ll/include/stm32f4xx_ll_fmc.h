 ...
 */
    ...
    #define IS_FMC_EXTENDED_MODE(__MODE__) (((__MODE__) == FMC_EXTENDED_MODE_DISABLE) || ((__MODE__) == FMC_EXTENDED_MODE_ENABLE))
 ...
 */
     ...
     */
        ...
        #define __FMC_NAND_ENABLE_IT(__INSTANCE__, __BANK__, __INTERRUPT__)                                                      \
            (((__BANK__) == FMC_NAND_BANK2) ? ((__INSTANCE__)->SR2 |= (__INTERRUPT__)) : ((__INSTANCE__)->SR3 |= (__INTERRUPT__)))
    #else
