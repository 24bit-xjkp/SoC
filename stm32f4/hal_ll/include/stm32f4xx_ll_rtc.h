...
#include "stm32f4xx.h"
    ...
    typedef struct
    {
        ...
        uint32_t AlarmDateWeekDaySel; /*!< Specifies the RTC Alarm is on day or WeekDay.
                                         ...
                                         or @ref RTC_LL_EC_ALMB_WEEKDAY_SELECTION for ALARM B
                                           ...
                                           This feature can be modified afterwards using unitary function @ref
                                         LL_RTC_ALMA_EnableWeekday() or @ref LL_RTC_ALMA_DisableWeekday() for ALARM A or @ref
                                         LL_RTC_ALMB_EnableWeekday() or @ref LL_RTC_ALMB_DisableWeekday() for ALARM B
                                      */
     ...
     *         @arg @ref LL_RTC_HOURFORMAT_AMPM
     */
    __STATIC_INLINE uint32_t LL_RTC_GetHourFormat(RTC_TypeDef* RTCx) { return (uint32_t)(READ_BIT(RTCx->CR, RTC_CR_FMT)); }
     ...
     *         @arg @ref LL_RTC_ALARMOUT_WAKEUP
     */
    __STATIC_INLINE uint32_t LL_RTC_GetAlarmOutEvent(RTC_TypeDef* RTCx) { return (uint32_t)(READ_BIT(RTCx->CR, RTC_CR_OSEL)); }
     ...
     *         @arg @ref LL_RTC_OUTPUTPOLARITY_PIN_LOW
     */
    __STATIC_INLINE uint32_t LL_RTC_GetOutputPolarity(RTC_TypeDef* RTCx) { return (uint32_t)(READ_BIT(RTCx->CR, RTC_CR_POL)); }
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RTC_EnableWriteProtection(RTC_TypeDef* RTCx) { WRITE_REG(RTCx->WPR, RTC_WRITE_PROTECTION_DISABLE); }
     ...
     *         @arg @ref LL_RTC_TIME_FORMAT_PM
     */
    __STATIC_INLINE uint32_t LL_RTC_TIME_GetFormat(RTC_TypeDef* RTCx) { return (uint32_t)(READ_BIT(RTCx->TR, RTC_TR_PM)); }
     ...
     */
    __STATIC_INLINE uint32_t LL_RTC_TIME_GetSubSecond(RTC_TypeDef* RTCx) { return (uint32_t)(READ_BIT(RTCx->SSR, RTC_SSR_SS)); }
    ...
    __STATIC_INLINE void LL_RTC_DATE_Config(RTC_TypeDef* RTCx, uint32_t WeekDay, uint32_t Day, uint32_t Month, uint32_t Year)
    {
        ...
        temp = (WeekDay << RTC_DR_WDU_Pos) | (((Year & 0xF0U) << (RTC_DR_YT_Pos - 4U)) | ((Year & 0x0FU) << RTC_DR_YU_Pos)) |
               (((Month & 0xF0U) << (RTC_DR_MT_Pos - 4U)) | ((Month & 0x0FU) << RTC_DR_MU_Pos)) |
               (((Day & 0xF0U) << (RTC_DR_DT_Pos - 4U)) | ((Day & 0x0FU) << RTC_DR_DU_Pos));
    ...
    {
        return (uint32_t)((LL_RTC_ALMA_GetHour(RTCx) << RTC_OFFSET_HOUR) | (LL_RTC_ALMA_GetMinute(RTCx) << RTC_OFFSET_MINUTE) |
    ...
    {
        return (uint32_t)((LL_RTC_ALMB_GetHour(RTCx) << RTC_OFFSET_HOUR) | (LL_RTC_ALMB_GetMinute(RTCx) << RTC_OFFSET_MINUTE) |
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RTC_TS_SetActiveEdge(RTC_TypeDef* RTCx, uint32_t Edge) { MODIFY_REG(RTCx->CR, RTC_CR_TSEDGE, Edge); }
     ...
     *         @arg @ref LL_RTC_TIMESTAMP_EDGE_FALLING
     */
    __STATIC_INLINE uint32_t LL_RTC_TS_GetActiveEdge(RTC_TypeDef* RTCx) { return (uint32_t)(READ_BIT(RTCx->CR, RTC_CR_TSEDGE)); }
     ...
     */
    __STATIC_INLINE uint32_t LL_RTC_TS_GetTimeFormat(RTC_TypeDef* RTCx) { return (uint32_t)(READ_BIT(RTCx->TSTR, RTC_TSTR_PM)); }
    ...
    {
        return (
            uint32_t)(READ_BIT(RTCx->TSTR, RTC_TSTR_HT | RTC_TSTR_HU | RTC_TSTR_MNT | RTC_TSTR_MNU | RTC_TSTR_ST | RTC_TSTR_SU));
    }
     ...
     */
    __STATIC_INLINE uint32_t LL_RTC_TS_GetSubSecond(RTC_TypeDef* RTCx) { return (uint32_t)(READ_BIT(RTCx->TSSSR, RTC_TSSSR_SS)); }
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RTC_TS_EnableOnTamper(RTC_TypeDef* RTCx) { SET_BIT(RTCx->TAFCR, RTC_TAFCR_TAMPTS); }
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RTC_TS_DisableOnTamper(RTC_TypeDef* RTCx) { CLEAR_BIT(RTCx->TAFCR, RTC_TAFCR_TAMPTS); }
     ...
     * @retval None
     */
    __STATIC_INLINE uint32_t LL_RTC_TS_GetPin(RTC_TypeDef* RTCx) { return (uint32_t)(READ_BIT(RTCx->TAFCR, RTC_TAFCR_TSINSEL)); }
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RTC_TAMPER_Enable(RTC_TypeDef* RTCx, uint32_t Tamper) { SET_BIT(RTCx->TAFCR, Tamper); }
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RTC_TAMPER_Disable(RTC_TypeDef* RTCx, uint32_t Tamper) { CLEAR_BIT(RTCx->TAFCR, Tamper); }
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RTC_TAMPER_DisablePullUp(RTC_TypeDef* RTCx) { SET_BIT(RTCx->TAFCR, RTC_TAFCR_TAMPPUDIS); }
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RTC_TAMPER_EnablePullUp(RTC_TypeDef* RTCx) { CLEAR_BIT(RTCx->TAFCR, RTC_TAFCR_TAMPPUDIS); }
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RTC_TAMPER_EnableActiveLevel(RTC_TypeDef* RTCx, uint32_t Tamper) { SET_BIT(RTCx->TAFCR, Tamper); }
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RTC_TAMPER_DisableActiveLevel(RTC_TypeDef* RTCx, uint32_t Tamper) { CLEAR_BIT(RTCx->TAFCR, Tamper); }
     ...
     *         @arg @ref LL_RTC_WAKEUPCLOCK_CKSPRE_WUT
     */
    __STATIC_INLINE uint32_t LL_RTC_WAKEUP_GetClock(RTC_TypeDef* RTCx) { return (uint32_t)(READ_BIT(RTCx->CR, RTC_CR_WUCKSEL)); }
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RTC_CAL_DisableCoarseDigital(RTC_TypeDef* RTCx) { CLEAR_BIT(RTCx->CR, RTC_CR_DCE); }
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RTC_CAL_SetPulse(RTC_TypeDef* RTCx, uint32_t Pulse) { MODIFY_REG(RTCx->CALR, RTC_CALR_CALP, Pulse); }
     ...
     */
    __STATIC_INLINE uint32_t LL_RTC_CAL_GetMinus(RTC_TypeDef* RTCx) { return (uint32_t)(READ_BIT(RTCx->CALR, RTC_CALR_CALM)); }
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_RTC_DisableIT_TAMP(RTC_TypeDef* RTCx) { CLEAR_BIT(RTCx->TAFCR, RTC_TAFCR_TAMPIE); }
