...
/* ----------------------- FMC registers bit mask --------------------------- */
        ...
        #define BTR_CLEAR_MASK                                                                                                   \
            ((uint32_t)(FMC_BTR1_ADDSET | FMC_BTR1_ADDHLD | FMC_BTR1_DATAST | FMC_BTR1_BUSTURN | FMC_BTR1_CLKDIV |               \
                        FMC_BTR1_DATLAT | FMC_BTR1_ACCMOD))

        /* --- BWTR Register ---*/
        /* BWTR register clear mask */
        #define BWTR_CLEAR_MASK                                                                                                  \
            ((uint32_t)(FMC_BWTR1_ADDSET | FMC_BWTR1_ADDHLD | FMC_BWTR1_DATAST | FMC_BWTR1_BUSTURN | FMC_BWTR1_ACCMOD))
    #endif /* FMC_Bank1 */
            ...
            #define PATT_CLEAR_MASK ((uint32_t)(FMC_PATT_ATTSET2 | FMC_PATT_ATTWAIT2 | FMC_PATT_ATTHOLD2 | FMC_PATT_ATTHIZ2))
        #else
            /* --- PCR Register ---*/
            /* PCR register clear mask */
            #define PCR_CLEAR_MASK                                                                                               \
                ((uint32_t)(FMC_PCR2_PWAITEN | FMC_PCR2_PBKEN | FMC_PCR2_PTYP | FMC_PCR2_PWID | FMC_PCR2_ECCEN | FMC_PCR2_TCLR | \
                            FMC_PCR2_TAR | FMC_PCR2_ECCPS))
            /* --- PMEM Register ---*/
            /* PMEM register clear mask */
            #define PMEM_CLEAR_MASK ((uint32_t)(FMC_PMEM2_MEMSET2 | FMC_PMEM2_MEMWAIT2 | FMC_PMEM2_MEMHOLD2 | FMC_PMEM2_MEMHIZ2))

            /* --- PATT Register ---*/
            /* PATT register clear mask */
            #define PATT_CLEAR_MASK ((uint32_t)(FMC_PATT2_ATTSET2 | FMC_PATT2_ATTWAIT2 | FMC_PATT2_ATTHOLD2 | FMC_PATT2_ATTHIZ2))
        ...
        #define PCR4_CLEAR_MASK                                                                                                  \
            ((uint32_t)(FMC_PCR4_PWAITEN | FMC_PCR4_PBKEN | FMC_PCR4_PTYP | FMC_PCR4_PWID | FMC_PCR4_ECCEN | FMC_PCR4_TCLR |     \
                        FMC_PCR4_TAR | FMC_PCR4_ECCPS))
        /* --- PMEM Register ---*/
        /* PMEM register clear mask */
        #define PMEM4_CLEAR_MASK ((uint32_t)(FMC_PMEM4_MEMSET4 | FMC_PMEM4_MEMWAIT4 | FMC_PMEM4_MEMHOLD4 | FMC_PMEM4_MEMHIZ4))

        /* --- PATT Register ---*/
        /* PATT register clear mask */
        #define PATT4_CLEAR_MASK ((uint32_t)(FMC_PATT4_ATTSET4 | FMC_PATT4_ATTWAIT4 | FMC_PATT4_ATTHOLD4 | FMC_PATT4_ATTHIZ4))

        /* --- PIO4 Register ---*/
        /* PIO4 register clear mask */
        #define PIO4_CLEAR_MASK ((uint32_t)(FMC_PIO4_IOSET4 | FMC_PIO4_IOWAIT4 | FMC_PIO4_IOHOLD4 | FMC_PIO4_IOHIZ4))
        ...
        #define SDCR_CLEAR_MASK                                                                                                  \
            ((uint32_t)(FMC_SDCR1_NC | FMC_SDCR1_NR | FMC_SDCR1_MWID | FMC_SDCR1_NB | FMC_SDCR1_CAS | FMC_SDCR1_WP |             \
                        FMC_SDCR1_SDCLK | FMC_SDCR1_RBURST | FMC_SDCR1_RPIPE))

        /* --- SDTR Register ---*/
        /* SDTR register clear mask */
        #define SDTR_CLEAR_MASK                                                                                                  \
            ((uint32_t)(FMC_SDTR1_TMRD | FMC_SDTR1_TXSR | FMC_SDTR1_TRAS | FMC_SDTR1_TRC | FMC_SDTR1_TWR | FMC_SDTR1_TRP |       \
                        FMC_SDTR1_TRCD))
    #endif /* FMC_Bank5_6 */
...
HAL_StatusTypeDef FMC_NORSRAM_Init(FMC_NORSRAM_TypeDef* Device, FMC_NORSRAM_InitTypeDef* Init)
{
    ...
    if(Init->MemoryType == FMC_MEMORY_TYPE_NOR) { flashaccess = FMC_NORSRAM_FLASH_ACCESS_ENABLE; }
    else { flashaccess = FMC_NORSRAM_FLASH_ACCESS_DISABLE; }
    ...
    mask =
        (FMC_BCR1_MBKEN | FMC_BCR1_MUXEN | FMC_BCR1_MTYP | FMC_BCR1_MWID | FMC_BCR1_FACCEN | FMC_BCR1_BURSTEN | FMC_BCR1_WAITPOL |
         FMC_BCR1_WAITCFG | FMC_BCR1_WREN | FMC_BCR1_WAITEN | FMC_BCR1_EXTMOD | FMC_BCR1_ASYNCWAIT | FMC_BCR1_CBURSTRW);
...
HAL_StatusTypeDef FMC_NORSRAM_DeInit(FMC_NORSRAM_TypeDef* Device, FMC_NORSRAM_EXTENDED_TypeDef* ExDevice, uint32_t Bank)
{
    ...
    /* FMC_NORSRAM_BANK1 */
    if(Bank == FMC_NORSRAM_BANK1) { Device->BTCR[Bank] = 0x000030DBU; }
...
HAL_StatusTypeDef FMC_NORSRAM_Timing_Init(FMC_NORSRAM_TypeDef* Device, FMC_NORSRAM_TimingTypeDef* Timing, uint32_t Bank)
{
    ...
    MODIFY_REG(Device->BTCR[Bank + 1U],
               ...
               (Timing->AddressSetupTime | ((Timing->AddressHoldTime) << FMC_BTR1_ADDHLD_Pos) |
                ((Timing->DataSetupTime) << FMC_BTR1_DATAST_Pos) | ((Timing->BusTurnAroundDuration) << FMC_BTR1_BUSTURN_Pos) |
                (((Timing->CLKDivision) - 1U) << FMC_BTR1_CLKDIV_Pos) | (((Timing->DataLatency) - 2U) << FMC_BTR1_DATLAT_Pos) |
                (Timing->AccessMode)));
...
HAL_StatusTypeDef FMC_NAND_Init(FMC_NAND_TypeDef* Device, FMC_NAND_InitTypeDef* Init)
{
    ...
    if(Init->NandBank == FMC_NAND_BANK2)
    {
        ...
        MODIFY_REG(Device->PCR2,
                   ...
                   (Init->Waitfeature | FMC_PCR_MEMORY_TYPE_NAND | Init->MemoryDataWidth | Init->EccComputation |
                    Init->ECCPageSize | ((Init->TCLRSetupTime) << FMC_PCR2_TCLR_Pos) |
    ...
    MODIFY_REG(Device->PCR,
               PCR_CLEAR_MASK,
               (Init->Waitfeature | FMC_PCR_MEMORY_TYPE_NAND | Init->MemoryDataWidth | Init->EccComputation | Init->ECCPageSize |
                ((Init->TCLRSetupTime) << FMC_PCR_TCLR_Pos) | ((Init->TARSetupTime) << FMC_PCR_TAR_Pos)));
        #endif
...
HAL_StatusTypeDef FMC_NAND_CommonSpace_Timing_Init(FMC_NAND_TypeDef* Device, FMC_NAND_PCC_TimingTypeDef* Timing, uint32_t Bank)
{
    ...
    if(Bank == FMC_NAND_BANK2)
    {
        ...
        MODIFY_REG(Device->PMEM2,
                   PMEM_CLEAR_MASK,
                   (Timing->SetupTime | ((Timing->WaitSetupTime) << FMC_PMEM2_MEMWAIT2_Pos) |
                    ((Timing->HoldSetupTime) << FMC_PMEM2_MEMHOLD2_Pos) | ((Timing->HiZSetupTime) << FMC_PMEM2_MEMHIZ2_Pos)));
    }
    else
    {
        /* NAND bank 3 registers configuration */
    ...
    MODIFY_REG(Device->PMEM,
               PMEM_CLEAR_MASK,
               (Timing->SetupTime | ((Timing->WaitSetupTime) << FMC_PMEM_MEMWAIT2_Pos) |
                ((Timing->HoldSetupTime) << FMC_PMEM_MEMHOLD2_Pos) | ((Timing->HiZSetupTime) << FMC_PMEM_MEMHIZ2_Pos)));
        #endif
...
HAL_StatusTypeDef FMC_NAND_AttributeSpace_Timing_Init(FMC_NAND_TypeDef* Device, FMC_NAND_PCC_TimingTypeDef* Timing, uint32_t Bank)
{
    ...
    if(Bank == FMC_NAND_BANK2)
    {
        ...
        MODIFY_REG(Device->PATT2,
                   PATT_CLEAR_MASK,
                   (Timing->SetupTime | ((Timing->WaitSetupTime) << FMC_PATT2_ATTWAIT2_Pos) |
                    ((Timing->HoldSetupTime) << FMC_PATT2_ATTHOLD2_Pos) | ((Timing->HiZSetupTime) << FMC_PATT2_ATTHIZ2_Pos)));
    }
    else
    {
        /* NAND bank 3 registers configuration */
    ...
    MODIFY_REG(Device->PATT,
               PATT_CLEAR_MASK,
               (Timing->SetupTime | ((Timing->WaitSetupTime) << FMC_PATT_ATTWAIT2_Pos) |
                ((Timing->HoldSetupTime) << FMC_PATT_ATTHOLD2_Pos) | ((Timing->HiZSetupTime) << FMC_PATT_ATTHIZ2_Pos)));
        #endif
...
HAL_StatusTypeDef FMC_NAND_ECC_Enable(FMC_NAND_TypeDef* Device, uint32_t Bank)
{
    ...
    assert_param(IS_FMC_NAND_BANK(Bank));
        ...
        /* Enable ECC feature */
        #if defined(FMC_Bank2_3)
    if(Bank == FMC_NAND_BANK2) { SET_BIT(Device->PCR2, FMC_PCR2_ECCEN); }
    else { SET_BIT(Device->PCR3, FMC_PCR2_ECCEN); }
        #else
    /* Prevent unused argument(s) compilation warning if no assert_param check */
    UNUSED(Bank);
...
HAL_StatusTypeDef FMC_NAND_ECC_Disable(FMC_NAND_TypeDef* Device, uint32_t Bank)
{
    ...
    assert_param(IS_FMC_NAND_BANK(Bank));
        ...
        /* Disable ECC feature */
        #if defined(FMC_Bank2_3)
    if(Bank == FMC_NAND_BANK2) { CLEAR_BIT(Device->PCR2, FMC_PCR2_ECCEN); }
    else { CLEAR_BIT(Device->PCR3, FMC_PCR2_ECCEN); }
        #else
    /* Prevent unused argument(s) compilation warning if no assert_param check */
    UNUSED(Bank);
...
HAL_StatusTypeDef FMC_PCCARD_Init(FMC_PCCARD_TypeDef* Device, FMC_PCCARD_InitTypeDef* Init)
{
    ...
    MODIFY_REG(Device->PCR4,
               ...
               (FMC_PCR_MEMORY_TYPE_PCCARD | Init->Waitfeature | FMC_NAND_PCC_MEM_BUS_WIDTH_16 |
                (Init->TCLRSetupTime << FMC_PCR4_TCLR_Pos) | (Init->TARSetupTime << FMC_PCR4_TAR_Pos)));
...
HAL_StatusTypeDef FMC_PCCARD_CommonSpace_Timing_Init(FMC_PCCARD_TypeDef* Device, FMC_NAND_PCC_TimingTypeDef* Timing)
{
    ...
    MODIFY_REG(Device->PMEM4,
               PMEM4_CLEAR_MASK,
               (Timing->SetupTime | ((Timing->WaitSetupTime) << FMC_PMEM4_MEMWAIT4_Pos) |
                ((Timing->HoldSetupTime) << FMC_PMEM4_MEMHOLD4_Pos) | ((Timing->HiZSetupTime) << FMC_PMEM4_MEMHIZ4_Pos)));
...
HAL_StatusTypeDef FMC_PCCARD_AttributeSpace_Timing_Init(FMC_PCCARD_TypeDef* Device, FMC_NAND_PCC_TimingTypeDef* Timing)
{
    ...
    MODIFY_REG(Device->PATT4,
               PATT4_CLEAR_MASK,
               (Timing->SetupTime | ((Timing->WaitSetupTime) << FMC_PATT4_ATTWAIT4_Pos) |
                ((Timing->HoldSetupTime) << FMC_PATT4_ATTHOLD4_Pos) | ((Timing->HiZSetupTime) << FMC_PATT4_ATTHIZ4_Pos)));
...
HAL_StatusTypeDef FMC_PCCARD_IOSpace_Timing_Init(FMC_PCCARD_TypeDef* Device, FMC_NAND_PCC_TimingTypeDef* Timing)
{
    ...
    MODIFY_REG(Device->PIO4,
               PIO4_CLEAR_MASK,
               (Timing->SetupTime | (Timing->WaitSetupTime << FMC_PIO4_IOWAIT4_Pos) |
                (Timing->HoldSetupTime << FMC_PIO4_IOHOLD4_Pos) | (Timing->HiZSetupTime << FMC_PIO4_IOHIZ4_Pos)));
    ...
    if(Init->SDBank == FMC_SDRAM_BANK1)
    {
        MODIFY_REG(Device->SDCR[FMC_SDRAM_BANK1],
                   ...
                   (Init->ColumnBitsNumber | Init->RowBitsNumber | Init->MemoryDataWidth | Init->InternalBankNumber |
                    Init->CASLatency | Init->WriteProtection | Init->SDClockPeriod | Init->ReadBurst | Init->ReadPipeDelay));
    }
...
HAL_StatusTypeDef FMC_SDRAM_Timing_Init(FMC_SDRAM_TypeDef* Device, FMC_SDRAM_TimingTypeDef* Timing, uint32_t Bank)
{
    ...
    if(Bank == FMC_SDRAM_BANK1)
    {
        MODIFY_REG(Device->SDTR[FMC_SDRAM_BANK1],
                   SDTR_CLEAR_MASK,
                   (((Timing->LoadToActiveDelay) - 1U) | (((Timing->ExitSelfRefreshDelay) - 1U) << FMC_SDTR1_TXSR_Pos) |
                    (((Timing->SelfRefreshTime) - 1U) << FMC_SDTR1_TRAS_Pos) |
                    (((Timing->RowCycleDelay) - 1U) << FMC_SDTR1_TRC_Pos) |
                    (((Timing->WriteRecoveryTime) - 1U) << FMC_SDTR1_TWR_Pos) | (((Timing->RPDelay) - 1U) << FMC_SDTR1_TRP_Pos) |
    ...
    else /* FMC_Bank2_SDRAM */
    {
        MODIFY_REG(Device->SDTR[FMC_SDRAM_BANK1],
                   ...
                   (((Timing->RowCycleDelay) - 1U) << FMC_SDTR1_TRC_Pos) | (((Timing->RPDelay) - 1U) << FMC_SDTR1_TRP_Pos));
...
HAL_StatusTypeDef FMC_SDRAM_SendCommand(FMC_SDRAM_TypeDef* Device, FMC_SDRAM_CommandTypeDef* Command, uint32_t Timeout)
{
    ...
    MODIFY_REG(Device->SDCMR,
               ...
               ((Command->CommandMode) | (Command->CommandTarget) | (((Command->AutoRefreshNumber) - 1U) << FMC_SDCMR_NRFS_Pos) |
    ...
    while(HAL_IS_BIT_SET(Device->SDSR, FMC_SDSR_BUSY))
    {
        ...
        if(Timeout != HAL_MAX_DELAY)
        {
            if((Timeout == 0U) || ((HAL_GetTick() - tickstart) > Timeout)) { return HAL_TIMEOUT; }
        }
    }
    return HAL_OK;
}
...
uint32_t FMC_SDRAM_GetModeStatus(const FMC_SDRAM_TypeDef* Device, uint32_t Bank)
{
    ...
    if(Bank == FMC_SDRAM_BANK1) { tmpreg = (uint32_t)(Device->SDSR & FMC_SDSR_MODES1); }
    else { tmpreg = ((uint32_t)(Device->SDSR & FMC_SDSR_MODES2) >> 2U); }
