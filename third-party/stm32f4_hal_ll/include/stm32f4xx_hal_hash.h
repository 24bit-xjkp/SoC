 ...
 */
    ...
    #endif /* (USE_HAL_HASH_REGISTER_CALLBACKS) */
    {
        ...
        const uint8_t* pHashMsgBuffPtr; /*!< Pointer to message buffer (HMAC only) */
    ...
    HAL_StatusTypeDef HASH_Start(HASH_HandleTypeDef* hhash,
                                 ...
                                 uint32_t Algorithm);
    HAL_StatusTypeDef
        HASH_Accumulate(HASH_HandleTypeDef* hhash, const uint8_t* const pInBuffer, uint32_t Size, uint32_t Algorithm);
    HAL_StatusTypeDef
        HASH_Accumulate_IT(HASH_HandleTypeDef* hhash, const uint8_t* const pInBuffer, uint32_t Size, uint32_t Algorithm);
    HAL_StatusTypeDef HASH_Start_IT(HASH_HandleTypeDef* hhash,
                                    ...
                                    uint32_t Algorithm);
    HAL_StatusTypeDef
        HASH_Start_DMA(HASH_HandleTypeDef* hhash, const uint8_t* const pInBuffer, uint32_t Size, uint32_t Algorithm);
    ...
    HAL_StatusTypeDef HMAC_Start_IT(HASH_HandleTypeDef* hhash,
                                    ...
                                    uint32_t Algorithm);
    HAL_StatusTypeDef
        HMAC_Start_DMA(HASH_HandleTypeDef* hhash, const uint8_t* const pInBuffer, uint32_t Size, uint32_t Algorithm);
