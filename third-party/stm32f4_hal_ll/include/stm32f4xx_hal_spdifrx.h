...
#include "stm32f4xx_hal_def.h"
    ...
    HAL_SPDIFRX_StateTypeDef HAL_SPDIFRX_GetState(const SPDIFRX_HandleTypeDef* const hspdif);
    uint32_t HAL_SPDIFRX_GetError(const SPDIFRX_HandleTypeDef* const hspdif);
        /**
         * @}
         */
