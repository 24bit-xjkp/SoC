...
HAL_StatusTypeDef HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef* PeriphClkInit)
{
    ...
    if(((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_I2S_APB1) == (RCC_PERIPHCLK_I2S_APB1))
    {
        ...
        if(PeriphClkInit->I2sApb1ClockSelection == RCC_I2SAPB1CLKSOURCE_PLLI2S) { plli2sused = 1U; }
    }
    /*--------------------------------------------------------------------------*/
    ...
    if(((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_I2S_APB2) == (RCC_PERIPHCLK_I2S_APB2))
    {
        ...
        /* Enable the PLLI2S when it's used as clock source for I2S */
        if(PeriphClkInit->I2sApb2ClockSelection == RCC_I2SAPB2CLKSOURCE_PLLI2S) { plli2sused = 1U; }
    }
    /*--------------------------------------------------------------------------*/
    ...
    if(((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI1) == (RCC_PERIPHCLK_SAI1))
    {
        ...
        if(PeriphClkInit->Sai1ClockSelection == RCC_SAI1CLKSOURCE_PLLI2S) { plli2sused = 1U; }
        /* Enable the PLLSAI when it's used as clock source for SAI */
        if(PeriphClkInit->Sai1ClockSelection == RCC_SAI1CLKSOURCE_PLLSAI) { pllsaiused = 1U; }
    }
    /*--------------------------------------------------------------------------*/
    ...
    if(((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI2) == (RCC_PERIPHCLK_SAI2))
    {
        ...
        /* Enable the PLLI2S when it's used as clock source for SAI */
        if(PeriphClkInit->Sai2ClockSelection == RCC_SAI2CLKSOURCE_PLLI2S) { plli2sused = 1U; }
        /* Enable the PLLSAI when it's used as clock source for SAI */
        if(PeriphClkInit->Sai2ClockSelection == RCC_SAI2CLKSOURCE_PLLSAI) { pllsaiused = 1U; }
    }
    /*--------------------------------------------------------------------------*/
    ...
    if(((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_CLK48) == RCC_PERIPHCLK_CLK48)
    {
        ...
        if(PeriphClkInit->Clk48ClockSelection == RCC_CLK48CLKSOURCE_PLLSAIP) { pllsaiused = 1U; }
    }
    /*--------------------------------------------------------------------------*/
    ...
    if(((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SPDIFRX) == RCC_PERIPHCLK_SPDIFRX)
    {
        ...
        if(PeriphClkInit->SpdifClockSelection == RCC_SPDIFRXCLKSOURCE_PLLI2SP) { plli2sused = 1U; }
    }
    /*--------------------------------------------------------------------------*/
...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef* PeriphClkInit)
{
    ...
    if((RCC->DCKCFGR & RCC_DCKCFGR_TIMPRE) == RESET) { PeriphClkInit->TIMPresSelection = RCC_TIMPRES_DESACTIVATED; }
    else { PeriphClkInit->TIMPresSelection = RCC_TIMPRES_ACTIVATED; }
}
    ...
    switch(PeriphClk)
    {
        ...
        case RCC_PERIPHCLK_I2S_APB1:
        {
            ...
            switch(srcclk)
            {
                ...
                {
                    if((RCC->PLLCFGR & RCC_PLLCFGR_PLLSRC) == RCC_PLLSOURCE_HSE) { frequency = HSE_VALUE; }
                    else { frequency = HSI_VALUE; }
                    break;
                }
...
HAL_StatusTypeDef HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef* PeriphClkInit)
{
    ...
    if(((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAIA) == (RCC_PERIPHCLK_SAIA))
    {
        ...
        /* Enable the PLLI2S when it's used as clock source for SAI */
        if(PeriphClkInit->SaiAClockSelection == RCC_SAIACLKSOURCE_PLLI2SR) { plli2sused = 1U; }
        /* Enable the PLLSAI when it's used as clock source for SAI */
    ...
    if(((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAIB) == (RCC_PERIPHCLK_SAIB))
    {
        ...
        /* Enable the PLLI2S when it's used as clock source for SAI */
        if(PeriphClkInit->SaiBClockSelection == RCC_SAIBCLKSOURCE_PLLI2SR) { plli2sused = 1U; }
        /* Enable the PLLSAI when it's used as clock source for SAI */
    ...
    if(((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_CLK48) == RCC_PERIPHCLK_CLK48)
    {
        ...
        if(PeriphClkInit->Clk48ClockSelection == RCC_CLK48CLKSOURCE_PLLI2SQ) { plli2sused = 1U; }
    }
    /*--------------------------------------------------------------------------*/
...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef* PeriphClkInit)
{
    ...
    PeriphClkInit->PeriphClockSelection =
        RCC_PERIPHCLK_I2S_APB1 | RCC_PERIPHCLK_I2S_APB2 | RCC_PERIPHCLK_TIM | RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_FMPI2C1 |
        RCC_PERIPHCLK_CLK48 | RCC_PERIPHCLK_SDIO | RCC_PERIPHCLK_DFSDM1 | RCC_PERIPHCLK_DFSDM1_AUDIO | RCC_PERIPHCLK_DFSDM2 |
        RCC_PERIPHCLK_DFSDM2_AUDIO | RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_SAIA | RCC_PERIPHCLK_SAIB;
    ...
    PeriphClkInit->PeriphClockSelection = RCC_PERIPHCLK_I2S_APB1 | RCC_PERIPHCLK_I2S_APB2 | RCC_PERIPHCLK_TIM |
                                          RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_FMPI2C1 | RCC_PERIPHCLK_CLK48 | RCC_PERIPHCLK_SDIO |
...
uint32_t HAL_RCCEx_GetPeriphCLKFreq(uint32_t PeriphClk)
{
    ...
    return frequency;
        ...
        defined(STM32F469xx) || defined(STM32F479xx) || defined(STM32F412Zx) || defined(STM32F412Vx) || defined(STM32F412Rx) ||  \
...
void HAL_RCCEx_SelectLSEMode(uint8_t Mode)
{
    ...
    if(Mode == RCC_LSE_HIGHDRIVE_MODE) { SET_BIT(RCC->BDCR, RCC_BDCR_LSEMOD); }
    else { CLEAR_BIT(RCC->BDCR, RCC_BDCR_LSEMOD); }
}
...
HAL_StatusTypeDef HAL_RCCEx_EnablePLLI2S(RCC_PLLI2SInitTypeDef* PLLI2SInit)
{
    ...
    __HAL_RCC_PLLI2S_CONFIG(PLLI2SInit->PLLI2SM,
                            PLLI2SInit->PLLI2SN,
                            PLLI2SInit->PLLI2SP,
                            PLLI2SInit->PLLI2SQ,
                            PLLI2SInit->PLLI2SR);
...
HAL_StatusTypeDef HAL_RCC_DeInit(void)
{
    ...
    {
        if((HAL_GetTick() - tickstart) > HSI_TIMEOUT_VALUE) { return HAL_TIMEOUT; }
    }
    ...
    {
        if((HAL_GetTick() - tickstart) > HSE_TIMEOUT_VALUE) { return HAL_TIMEOUT; }
    }
    ...
    {
        if((HAL_GetTick() - tickstart) > PLL_TIMEOUT_VALUE) { return HAL_TIMEOUT; }
    }
    ...
    while(READ_BIT(RCC->CR, RCC_CR_PLLI2SRDY) != RESET)
    {
        if((HAL_GetTick() - tickstart) > PLLI2S_TIMEOUT_VALUE) { return HAL_TIMEOUT; }
    }
    #endif /* RCC_PLLI2S_SUPPORT */
    ...
    {
        if((HAL_GetTick() - tickstart) > PLLSAI_TIMEOUT_VALUE) { return HAL_TIMEOUT; }
    }
    #endif /* RCC_PLLSAI_SUPPORT */
    ...
    if(HAL_InitTick(uwTickPrio) != HAL_OK) { return HAL_ERROR; }
    else { return HAL_OK; }
}
...
HAL_StatusTypeDef HAL_RCC_OscConfig(const RCC_OscInitTypeDef* RCC_OscInitStruct)
{
    ...
    /* Check Null pointer */
    if(RCC_OscInitStruct == NULL) { return HAL_ERROR; }
    ...
    if(((RCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_LSI) == RCC_OSCILLATORTYPE_LSI)
    {
        ...
        if((RCC_OscInitStruct->LSIState) != RCC_LSI_OFF)
        {
            ...
            {
                if((HAL_GetTick() - tickstart) > LSI_TIMEOUT_VALUE) { return HAL_TIMEOUT; }
            }
        }
        else
        {
    ...
    if(((RCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_LSE) == RCC_OSCILLATORTYPE_LSE)
    {
        ...
        if(pwrclkchanged == SET) { __HAL_RCC_PWR_CLK_DISABLE(); }
    }
    /*-------------------------------- PLL Configuration -----------------------*/
    /* Check the parameters */
    ...
    if((RCC_OscInitStruct->PLL.PLLState) != RCC_PLL_NONE)
    {
        ...
        else
        {
            ...
            if((RCC_OscInitStruct->PLL.PLLState) == RCC_PLL_OFF) { return HAL_ERROR; }
            else
            {
...
void HAL_RCC_GetOscConfig(RCC_OscInitTypeDef* RCC_OscInitStruct)
{
    ...
    if((RCC->CR & RCC_CR_HSEBYP) == RCC_CR_HSEBYP) { RCC_OscInitStruct->HSEState = RCC_HSE_BYPASS; }
    else if((RCC->CR & RCC_CR_HSEON) == RCC_CR_HSEON) { RCC_OscInitStruct->HSEState = RCC_HSE_ON; }
    else { RCC_OscInitStruct->HSEState = RCC_HSE_OFF; }

    /* Get the HSI configuration -----------------------------------------------*/
    if((RCC->CR & RCC_CR_HSION) == RCC_CR_HSION) { RCC_OscInitStruct->HSIState = RCC_HSI_ON; }
    else { RCC_OscInitStruct->HSIState = RCC_HSI_OFF; }

    RCC_OscInitStruct->HSICalibrationValue = (uint32_t)((RCC->CR & RCC_CR_HSITRIM) >> RCC_CR_HSITRIM_Pos);

    /* Get the LSE configuration -----------------------------------------------*/
    if((RCC->BDCR & RCC_BDCR_LSEBYP) == RCC_BDCR_LSEBYP) { RCC_OscInitStruct->LSEState = RCC_LSE_BYPASS; }
    else if((RCC->BDCR & RCC_BDCR_LSEON) == RCC_BDCR_LSEON) { RCC_OscInitStruct->LSEState = RCC_LSE_ON; }
    else { RCC_OscInitStruct->LSEState = RCC_LSE_OFF; }

    /* Get the LSI configuration -----------------------------------------------*/
    if((RCC->CSR & RCC_CSR_LSION) == RCC_CSR_LSION) { RCC_OscInitStruct->LSIState = RCC_LSI_ON; }
    else { RCC_OscInitStruct->LSIState = RCC_LSI_OFF; }

    /* Get the PLL configuration -----------------------------------------------*/
    if((RCC->CR & RCC_CR_PLLON) == RCC_CR_PLLON) { RCC_OscInitStruct->PLL.PLLState = RCC_PLL_ON; }
    else { RCC_OscInitStruct->PLL.PLLState = RCC_PLL_OFF; }
