    ...
    #include "stm32f4xx_ll_rcc.h"
         ...
         */
            ...
            #define IS_LL_RCC_DFSDM_AUDIO_CLKSOURCE(__VALUE__)                                                                   \
                (((__VALUE__) == LL_RCC_DFSDM1_AUDIO_CLKSOURCE) || ((__VALUE__) == LL_RCC_DFSDM2_AUDIO_CLKSOURCE))
    ...
    if(FMPI2CxSource == LL_RCC_FMPI2C1_CLKSOURCE)
    {
        ...
        switch(LL_RCC_GetFMPI2CClockSource(FMPI2CxSource))
        {
            ...
            case LL_RCC_FMPI2C1_CLKSOURCE_HSI: /* FMPI2C1 Clock is HSI Osc. */
                if(LL_RCC_HSI_IsReady()) { FMPI2C_frequency = HSI_VALUE; }
                break;

            case LL_RCC_FMPI2C1_CLKSOURCE_PCLK1: /* FMPI2C1 Clock is PCLK1 */
            default: FMPI2C_frequency = RCC_GetPCLK1ClockFreq(RCC_GetHCLKClockFreq(RCC_GetSystemClockFreq())); break;
        }
    }
    ...
    if(I2SxSource == LL_RCC_I2S1_CLKSOURCE)
    {
        ...
        switch(LL_RCC_GetI2SClockSource(I2SxSource))
        {
            ...
            case LL_RCC_I2S1_CLKSOURCE_PLLI2S: /* I2S1 Clock is PLLI2S */
                if(LL_RCC_PLLI2S_IsReady()) { i2s_frequency = RCC_PLLI2S_GetFreqDomain_I2S(); }
                break;
        #endif /* RCC_PLLI2S_SUPPORT */

        #if defined(RCC_DCKCFGR_I2SSRC) || defined(RCC_DCKCFGR_I2S1SRC)
            case LL_RCC_I2S1_CLKSOURCE_PLL: /* I2S1 Clock is PLL */
                if(LL_RCC_PLL_IsReady()) { i2s_frequency = RCC_PLL_GetFreqDomain_I2S(); }
                break;
            ...
            case LL_RCC_I2S1_CLKSOURCE_PLLSRC: /* I2S1 Clock is PLL Main source */
                switch(LL_RCC_PLL_GetMainSource())
                {
                    case LL_RCC_PLLSOURCE_HSE: /* I2S1 Clock is HSE Osc. */
                        if(LL_RCC_HSE_IsReady()) { i2s_frequency = HSE_VALUE; }
                        break;

                    case LL_RCC_PLLSOURCE_HSI: /* I2S1 Clock is HSI Osc. */
                    default:
                        if(LL_RCC_HSI_IsReady()) { i2s_frequency = HSI_VALUE; }
                        break;
                }
                break;
        #endif /* RCC_DCKCFGR_I2SSRC || RCC_DCKCFGR_I2S1SRC */
            ...
            default: i2s_frequency = EXTERNAL_CLOCK_VALUE; break;
        }
    }
        #if defined(RCC_DCKCFGR_I2S2SRC)
    else
    ...
    if(LPTIMxSource == LL_RCC_LPTIM1_CLKSOURCE)
    {
        ...
        switch(LL_RCC_GetLPTIMClockSource(LPTIMxSource))
        {
            case LL_RCC_LPTIM1_CLKSOURCE_LSI: /* LPTIM1 Clock is LSI Osc. */
                if(LL_RCC_LSI_IsReady()) { lptim_frequency = LSI_VALUE; }
                break;

            case LL_RCC_LPTIM1_CLKSOURCE_HSI: /* LPTIM1 Clock is HSI Osc. */
                if(LL_RCC_HSI_IsReady()) { lptim_frequency = HSI_VALUE; }
                break;

            case LL_RCC_LPTIM1_CLKSOURCE_LSE: /* LPTIM1 Clock is LSE Osc. */
                if(LL_RCC_LSE_IsReady()) { lptim_frequency = LSE_VALUE; }
                break;

            case LL_RCC_LPTIM1_CLKSOURCE_PCLK1: /* LPTIM1 Clock is PCLK1 */
            default: lptim_frequency = RCC_GetPCLK1ClockFreq(RCC_GetHCLKClockFreq(RCC_GetSystemClockFreq())); break;
        }
    }
    ...
    if((SAIxSource == LL_RCC_SAI1_CLKSOURCE) || (SAIxSource == LL_RCC_SAI2_CLKSOURCE))
    {
        ...
        switch(LL_RCC_GetSAIClockSource(SAIxSource))
        {
            ...
            case LL_RCC_SAI2_CLKSOURCE_PLLSAI: /* PLLSAI clock used as SAI2 clock source */
                if(LL_RCC_PLLSAI_IsReady()) { sai_frequency = RCC_PLLSAI_GetFreqDomain_SAI(); }
                break;
            ...
            case LL_RCC_SAI2_CLKSOURCE_PLLI2S: /* PLLI2S clock used as SAI2 clock source */
                if(LL_RCC_PLLI2S_IsReady()) { sai_frequency = RCC_PLLI2S_GetFreqDomain_SAI(); }
                break;

            case LL_RCC_SAI1_CLKSOURCE_PLL: /* PLL clock used as SAI1 clock source */
            case LL_RCC_SAI2_CLKSOURCE_PLL: /* PLL clock used as SAI2 clock source */
                if(LL_RCC_PLL_IsReady()) { sai_frequency = RCC_PLL_GetFreqDomain_SAI(); }
                break;
            ...
            case LL_RCC_SAI2_CLKSOURCE_PLLSRC:
                switch(LL_RCC_PLL_GetMainSource())
                {
                    case LL_RCC_PLLSOURCE_HSE: /* HSE clock used as SAI2 clock source */
                        if(LL_RCC_HSE_IsReady()) { sai_frequency = HSE_VALUE; }
                        break;

                    case LL_RCC_PLLSOURCE_HSI: /* HSI clock used as SAI2 clock source */
                    default:
                        if(LL_RCC_HSI_IsReady()) { sai_frequency = HSI_VALUE; }
                        break;
                }
                break;

            case LL_RCC_SAI1_CLKSOURCE_PIN: /* External input clock used as SAI1 clock source */
            default: sai_frequency = EXTERNAL_CLOCK_VALUE; break;
        }
    }
            #endif /* RCC_DCKCFGR_SAI1SRC */
...
uint32_t LL_RCC_GetSDIOClockFreq(uint32_t SDIOxSource)
{
    ...
    if(SDIOxSource == LL_RCC_SDIO_CLKSOURCE)
    {
        ...
        switch(LL_RCC_GetSDIOClockSource(SDIOxSource))
        {
            case LL_RCC_SDIO_CLKSOURCE_PLL48CLK: /* PLL48M clock used as SDIO clock source */
                switch(LL_RCC_GetCK48MClockSource(LL_RCC_CK48M_CLKSOURCE))
                {
                    case LL_RCC_CK48M_CLKSOURCE_PLL: /* PLL clock used as 48Mhz domain clock */
                        if(LL_RCC_PLL_IsReady()) { SDIO_frequency = RCC_PLL_GetFreqDomain_48M(); }
                        break;

                #if defined(RCC_PLLSAI_SUPPORT)
                    case LL_RCC_CK48M_CLKSOURCE_PLLSAI: /* PLLSAI clock used as 48Mhz domain clock */
                    default:
                        if(LL_RCC_PLLSAI_IsReady()) { SDIO_frequency = RCC_PLLSAI_GetFreqDomain_48M(); }
                        break;
                #endif /* RCC_PLLSAI_SUPPORT */
                    ...
                    default:
                        if(LL_RCC_PLLI2S_IsReady()) { SDIO_frequency = RCC_PLLI2S_GetFreqDomain_48M(); }
                        break;
                #endif /* RCC_PLLI2SCFGR_PLLI2SQ && !RCC_DCKCFGR_PLLI2SDIVQ */
                }
                break;
            ...
            default: SDIO_frequency = RCC_GetSystemClockFreq(); break;
        }
            #else
...
uint32_t LL_RCC_GetRNGClockFreq(uint32_t RNGxSource)
{
    ...
    switch(LL_RCC_GetRNGClockSource(RNGxSource))
    {
        ...
        case LL_RCC_RNG_CLKSOURCE_PLLI2S: /* PLLI2S clock used as RNG clock source */
            if(LL_RCC_PLLI2S_IsReady()) { rng_frequency = RCC_PLLI2S_GetFreqDomain_48M(); }
            break;
                #endif /* RCC_PLLI2SCFGR_PLLI2SQ && !RCC_DCKCFGR_PLLI2SDIVQ */

                #if defined(RCC_PLLSAI_SUPPORT)
        case LL_RCC_RNG_CLKSOURCE_PLLSAI: /* PLLSAI clock used as RNG clock source */
            if(LL_RCC_PLLSAI_IsReady()) { rng_frequency = RCC_PLLSAI_GetFreqDomain_48M(); }
            break;
                #endif /* RCC_PLLSAI_SUPPORT */

        case LL_RCC_RNG_CLKSOURCE_PLL: /* PLL clock used as RNG clock source */
        default:
            if(LL_RCC_PLL_IsReady()) { rng_frequency = RCC_PLL_GetFreqDomain_48M(); }
            break;
    }
            #else
...
uint32_t LL_RCC_GetCECClockFreq(uint32_t CECxSource)
{
    ...
    switch(LL_RCC_GetCECClockSource(CECxSource))
    {
        case LL_RCC_CEC_CLKSOURCE_LSE: /* CEC Clock is LSE Osc. */
            if(LL_RCC_LSE_IsReady()) { cec_frequency = LSE_VALUE; }
            break;

        case LL_RCC_CEC_CLKSOURCE_HSI_DIV488: /* CEC Clock is HSI Osc. */
        default:
            if(LL_RCC_HSI_IsReady()) { cec_frequency = HSI_VALUE / 488U; }
            break;
    }
...
uint32_t LL_RCC_GetUSBClockFreq(uint32_t USBxSource)
{
    ...
    switch(LL_RCC_GetUSBClockSource(USBxSource))
    {
        ...
        case LL_RCC_USB_CLKSOURCE_PLLI2S: /* PLLI2S clock used as USB clock source */
            if(LL_RCC_PLLI2S_IsReady()) { usb_frequency = RCC_PLLI2S_GetFreqDomain_48M(); }
            break;
        ...
        case LL_RCC_USB_CLKSOURCE_PLLSAI: /* PLLSAI clock used as USB clock source */
            if(LL_RCC_PLLSAI_IsReady()) { usb_frequency = RCC_PLLSAI_GetFreqDomain_48M(); }
            break;
                #endif /* RCC_PLLSAI_SUPPORT */

        case LL_RCC_USB_CLKSOURCE_PLL: /* PLL clock used as USB clock source */
        default:
            if(LL_RCC_PLL_IsReady()) { usb_frequency = RCC_PLL_GetFreqDomain_48M(); }
            break;
    }
            #else
...
uint32_t LL_RCC_GetDFSDMClockFreq(uint32_t DFSDMxSource)
{
    ...
    if(DFSDMxSource == LL_RCC_DFSDM1_CLKSOURCE)
    {
        ...
        {
            case LL_RCC_DFSDM1_CLKSOURCE_SYSCLK: /* DFSDM1 Clock is SYSCLK */ dfsdm_frequency = RCC_GetSystemClockFreq(); break;

            case LL_RCC_DFSDM1_CLKSOURCE_PCLK2: /* DFSDM1 Clock is PCLK2 */
            default: dfsdm_frequency = RCC_GetPCLK2ClockFreq(RCC_GetHCLKClockFreq(RCC_GetSystemClockFreq())); break;
        }
    }
            #if defined(DFSDM2_Channel0)
    else
    {
        ...
        switch(LL_RCC_GetDFSDMClockSource(DFSDMxSource))
        {
            case LL_RCC_DFSDM2_CLKSOURCE_SYSCLK: /* DFSDM2 Clock is SYSCLK */ dfsdm_frequency = RCC_GetSystemClockFreq(); break;
...
uint32_t LL_RCC_GetDFSDMAudioClockFreq(uint32_t DFSDMxSource)
{
    ...
    if(DFSDMxSource == LL_RCC_DFSDM1_AUDIO_CLKSOURCE)
    {
        ...
        switch(LL_RCC_GetDFSDMAudioClockSource(DFSDMxSource))
        {
            ...
            default: dfsdm_frequency = LL_RCC_GetI2SClockFreq(LL_RCC_I2S2_CLKSOURCE); break;
        }
    }
            #if defined(DFSDM2_Channel0)
    else
...
uint32_t LL_RCC_GetDSIClockFreq(uint32_t DSIxSource)
{
    ...
    switch(LL_RCC_GetDSIClockSource(DSIxSource))
    {
        case LL_RCC_DSI_CLKSOURCE_PLL: /* DSI Clock is PLL Osc. */
            if(LL_RCC_PLL_IsReady()) { dsi_frequency = RCC_PLL_GetFreqDomain_DSI(); }
            break;

        case LL_RCC_DSI_CLKSOURCE_PHY: /* DSI Clock is DSI physical clock. */
        default: dsi_frequency = LL_RCC_PERIPH_FREQUENCY_NA; break;
    }
...
uint32_t LL_RCC_GetLTDCClockFreq(uint32_t LTDCxSource)
{
    ...
    if(LL_RCC_PLLSAI_IsReady()) { ltdc_frequency = RCC_PLLSAI_GetFreqDomain_LTDC(); }
...
uint32_t LL_RCC_GetSPDIFRXClockFreq(uint32_t SPDIFRXxSource)
{
    ...
    switch(LL_RCC_GetSPDIFRXClockSource(SPDIFRXxSource))
    {
        case LL_RCC_SPDIFRX1_CLKSOURCE_PLLI2S: /* SPDIFRX Clock is PLLI2S Osc. */
            if(LL_RCC_PLLI2S_IsReady()) { spdifrx_frequency = RCC_PLLI2S_GetFreqDomain_SPDIFRX(); }
            break;

        case LL_RCC_SPDIFRX1_CLKSOURCE_PLL: /* SPDIFRX Clock is PLL Osc. */
        default:
            if(LL_RCC_PLL_IsReady()) { spdifrx_frequency = RCC_PLL_GetFreqDomain_SPDIFRX(); }
            break;
    }
...
uint32_t RCC_GetSystemClockFreq(void)
{
    ...
    {
        case LL_RCC_SYS_CLKSOURCE_STATUS_HSI: /* HSI used as system clock  source */ frequency = HSI_VALUE; break;

        case LL_RCC_SYS_CLKSOURCE_STATUS_HSE: /* HSE used as system clock  source */ frequency = HSE_VALUE; break;
        ...
        default: frequency = HSI_VALUE; break;
    }
...
uint32_t RCC_PLL_GetFreqDomain_SYS(uint32_t SYSCLK_Source)
{
    ...
    */
    ...
    switch(pllsource)
    {
        case LL_RCC_PLLSOURCE_HSI: /* HSI used as PLL clock source */ pllinputfreq = HSI_VALUE; break;

        case LL_RCC_PLLSOURCE_HSE: /* HSE used as PLL clock source */ pllinputfreq = HSE_VALUE; break;

        default: pllinputfreq = HSI_VALUE; break;
    }

    if(SYSCLK_Source == LL_RCC_SYS_CLKSOURCE_STATUS_PLL)
    {
        plloutputfreq = __LL_RCC_CALC_PLLCLK_FREQ(pllinputfreq, LL_RCC_PLL_GetDivider(), LL_RCC_PLL_GetN(), LL_RCC_PLL_GetP());
    }
        #if defined(RCC_PLLR_SYSCLK_SUPPORT)
    else
    {
        plloutputfreq = __LL_RCC_CALC_PLLRCLK_FREQ(pllinputfreq, LL_RCC_PLL_GetDivider(), LL_RCC_PLL_GetN(), LL_RCC_PLL_GetR());
    }
        #endif /* RCC_PLLR_SYSCLK_SUPPORT */
...
uint32_t RCC_PLL_GetFreqDomain_DSI(void)
{
    ...
    */
    ...
    return __LL_RCC_CALC_PLLCLK_DSI_FREQ(pllinputfreq, LL_RCC_PLL_GetDivider(), LL_RCC_PLL_GetN(), LL_RCC_PLL_GetR());
}
        #endif /* DSI */
...
uint32_t RCC_PLL_GetFreqDomain_I2S(void)
{
    ...
    */
    ...
    return __LL_RCC_CALC_PLLCLK_I2S_FREQ(pllinputfreq, LL_RCC_PLL_GetDivider(), LL_RCC_PLL_GetN(), LL_RCC_PLL_GetR());
}
        #endif /* RCC_DCKCFGR_I2SSRC || RCC_DCKCFGR_I2S1SRC */
...
uint32_t RCC_PLL_GetFreqDomain_SPDIFRX(void)
{
    ...
    */
    ...
    return __LL_RCC_CALC_PLLCLK_SPDIFRX_FREQ(pllinputfreq, LL_RCC_PLL_GetDivider(), LL_RCC_PLL_GetN(), LL_RCC_PLL_GetR());
}
        #endif /* SPDIFRX */
...
uint32_t RCC_PLL_GetFreqDomain_SAI(void)
{
    ...
    */
    ...
    plloutputfreq = __LL_RCC_CALC_PLLCLK_SAI_FREQ(pllinputfreq,
                                                  LL_RCC_PLL_GetDivider(),
                                                  LL_RCC_PLL_GetN(),
                                                  LL_RCC_PLL_GetR(),
                                                  LL_RCC_PLL_GetDIVR());
                #else
    plloutputfreq = __LL_RCC_CALC_PLLCLK_SAI_FREQ(pllinputfreq, LL_RCC_PLL_GetDivider(), LL_RCC_PLL_GetN(), LL_RCC_PLL_GetR());
...
uint32_t RCC_PLLSAI_GetFreqDomain_SAI(void)
{
    ...
    */
    ...
    switch(pllsource)
    {
        case LL_RCC_PLLSOURCE_HSI: /* HSI used as PLLSAI clock source */ pllinputfreq = HSI_VALUE; break;

        case LL_RCC_PLLSOURCE_HSE: /* HSE used as PLLSAI clock source */ pllinputfreq = HSE_VALUE; break;

        default: pllinputfreq = HSI_VALUE; break;
    }
    return __LL_RCC_CALC_PLLSAI_SAI_FREQ(pllinputfreq,
...
uint32_t RCC_PLLSAI_GetFreqDomain_48M(void)
{
    ...
    */
    ...
    return __LL_RCC_CALC_PLLSAI_48M_FREQ(pllinputfreq, LL_RCC_PLLSAI_GetDivider(), LL_RCC_PLLSAI_GetN(), LL_RCC_PLLSAI_GetP());
}
            #endif /* RCC_PLLSAICFGR_PLLSAIP */
...
uint32_t RCC_PLLSAI_GetFreqDomain_LTDC(void)
{
    ...
    */
    ...
    return __LL_RCC_CALC_PLLSAI_LTDC_FREQ(pllinputfreq,
                                          LL_RCC_PLLSAI_GetDivider(),
                                          LL_RCC_PLLSAI_GetN(),
                                          LL_RCC_PLLSAI_GetR(),
...
uint32_t RCC_PLLI2S_GetFreqDomain_SAI(void)
{
    ...
    */
    ...
    switch(plli2ssource)
    {
        case LL_RCC_PLLSOURCE_HSE: /* HSE used as PLLI2S clock source */ plli2sinputfreq = HSE_VALUE; break;
        ...
        default: plli2sinputfreq = HSI_VALUE; break;
    }

                #if defined(RCC_DCKCFGR_PLLI2SDIVQ)
    plli2soutputfreq = __LL_RCC_CALC_PLLI2S_SAI_FREQ(plli2sinputfreq,
...
uint32_t RCC_PLLI2S_GetFreqDomain_SPDIFRX(void)
{
    ...
    */
    ...
    switch(pllsource)
    {
        case LL_RCC_PLLSOURCE_HSE: /* HSE used as PLLI2S clock source */ pllinputfreq = HSE_VALUE; break;

        case LL_RCC_PLLSOURCE_HSI: /* HSI used as PLLI2S clock source */
        default: pllinputfreq = HSI_VALUE; break;
    }

    return __LL_RCC_CALC_PLLI2S_SPDIFRX_FREQ(pllinputfreq,
                                             LL_RCC_PLLI2S_GetDivider(),
                                             LL_RCC_PLLI2S_GetN(),
                                             LL_RCC_PLLI2S_GetP());
}
...
uint32_t RCC_PLLI2S_GetFreqDomain_I2S(void)
{
    ...
    */
    ...
    plli2soutputfreq =
        __LL_RCC_CALC_PLLI2S_I2S_FREQ(plli2sinputfreq, LL_RCC_PLLI2S_GetDivider(), LL_RCC_PLLI2S_GetN(), LL_RCC_PLLI2S_GetR());
...
uint32_t RCC_PLLI2S_GetFreqDomain_48M(void)
{
    ...
    */
    ...
    plli2soutputfreq =
        __LL_RCC_CALC_PLLI2S_48M_FREQ(plli2sinputfreq, LL_RCC_PLLI2S_GetDivider(), LL_RCC_PLLI2S_GetN(), LL_RCC_PLLI2S_GetQ());
