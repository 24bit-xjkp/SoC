includes("*/xmake.lua")
add_requires("stm32f4_hal_ll", {configs = {hse_value = get_config("hse_value"), assert = get_config("assert"), _custom_mode = get_config("mode")}})
target("SoC.stm32")
    set_kind("static")
    add_packages("stm32f4_hal_ll", {public = true})
