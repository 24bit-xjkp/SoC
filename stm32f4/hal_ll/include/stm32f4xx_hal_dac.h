...
#include "stm32f4xx_hal_def.h"
    ...
    #define DAC_TRIGGER_T4_TRGO                                                                                                  \
        (DAC_CR_TSEL1_2 | DAC_CR_TSEL1_0 | DAC_CR_TEN1) /*!< TIM4 TRGO selected as external conversion trigger for DAC channel   \
                                                         */
    #define DAC_TRIGGER_T5_TRGO                                                                                                  \
        (DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 | DAC_CR_TEN1) /*!< TIM3 TRGO selected as external conversion trigger for DAC channel   \
                                                         */
