         ...
         */
            ...
            #define IS_LL_FMPI2C_PERIPHERAL_MODE(__VALUE__)                                                                      \
                (((__VALUE__) == LL_FMPI2C_MODE_I2C) || ((__VALUE__) == LL_FMPI2C_MODE_SMBUS_HOST) ||                            \
                 ((__VALUE__) == LL_FMPI2C_MODE_SMBUS_DEVICE) || ((__VALUE__) == LL_FMPI2C_MODE_SMBUS_DEVICE_ARP))

            #define IS_LL_FMPI2C_ANALOG_FILTER(__VALUE__)                                                                        \
                (((__VALUE__) == LL_FMPI2C_ANALOGFILTER_ENABLE) || ((__VALUE__) == LL_FMPI2C_ANALOGFILTER_DISABLE))
            ...
            #define IS_LL_FMPI2C_TYPE_ACKNOWLEDGE(__VALUE__) (((__VALUE__) == LL_FMPI2C_ACK) || ((__VALUE__) == LL_FMPI2C_NACK))
...
ErrorStatus LL_FMPI2C_Init(FMPI2C_TypeDef* FMPI2Cx, const LL_FMPI2C_InitTypeDef* FMPI2C_InitStruct)
{
    ...
    if(FMPI2C_InitStruct->OwnAddress1 != 0U) { LL_FMPI2C_EnableOwnAddress1(FMPI2Cx); }
