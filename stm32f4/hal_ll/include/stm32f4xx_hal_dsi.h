...
#include "stm32f4xx_hal_def.h"
    ...
    #define IS_DSI_PLL_IDF(IDF)                                                                                                  \
        (((IDF) == DSI_PLL_IN_DIV1) || ((IDF) == DSI_PLL_IN_DIV2) || ((IDF) == DSI_PLL_IN_DIV3) || ((IDF) == DSI_PLL_IN_DIV4) || \
         ((IDF) == DSI_PLL_IN_DIV5) || ((IDF) == DSI_PLL_IN_DIV6) || ((IDF) == DSI_PLL_IN_DIV7))
    #define IS_DSI_PLL_ODF(ODF)                                                                                                  \
        (((ODF) == DSI_PLL_OUT_DIV1) || ((ODF) == DSI_PLL_OUT_DIV2) || ((ODF) == DSI_PLL_OUT_DIV4) || ((ODF) == DSI_PLL_OUT_DIV8))
    ...
    #define IS_DSI_READ_PACKET_TYPE(MODE)                                                                                        \
        (((MODE) == DSI_DCS_SHORT_PKT_READ) || ((MODE) == DSI_GEN_SHORT_PKT_READ_P0) || ((MODE) == DSI_GEN_SHORT_PKT_READ_P1) || \
